			...
			<section className="max-w-7xl mx-auto px-4 py-16 flex flex-col md:flex-row items-center">
				...
				<div className="w-full md:w-1/2 md:pl-12 text-left md:text-left">
					...
					<p className="font-poppins text-gray-700 text-lg md:text-md mb-4">
						...
						the finest hotels, suites, and shortlet
						apartments in Lagos. Our properties are designed
						to provide comfort, elegance, and unmatched
						hospitality, ensuring that your stay with us is
						both relaxing and memorable.
					</p>
					<p className="font-poppins text-gray-700 text-lg md:text-md mb-4">
						We pride ourselves on our commitment to quality
						and customer satisfaction. Every detail of our
						accommodations is meticulously curated to meet
						the needs of our guests, whether you're
						traveling for business or leisure. Our dedicated
						staff is always on hand to ensure your
					...
					<p className="font-poppins text-gray-700 text-lg mb-4">
						...
						modern amenities. Discover vibrant
						neighborhoods, exquisite dining options, and
						exciting attractions, all just moments away from
						your doorstep.
					</p>
